    ...
    <HashRouter>
      <Routes>
        ...
        <Route path="/" element={
          ...
          <Route path="cms/announcement" element={<CMS activeTab="announcement" />} />
          <Route path="cms/trust" element={<CMS activeTab="trust" />} />
          <Route path="cms/newsletter" element={<CMS activeTab="newsletter" />} />
