...
import { LayoutDashboard, Shirt, ShoppingBag, FileText, Settings, Image, MessageSquare, ChevronDown } from 'lucide-react';
...
const Sidebar = ({ onLogout }) => {
    ...
    const navItems = [
        ...
        { path: '/products', name: 'Products', icon: <Shirt size={20} /> },
    ...
    const cmsItems = [
        { path: '/cms/hero', name: 'Header & Hero' },
        { path: '/cms/announcement', name: 'Announcement & Promo' },
        { path: '/cms/trust', name: 'Trust Bar & Stats' },
        { path: '/cms/newsletter', name: 'Newsletter' },
        { path: '/cms/footer', name: 'Footer & Contact' },
    ];

    return (
        <div className="w-64 bg-white border-r border-gray-200 h-screen flex flex-col fixed top-0 left-0">
            <div className="h-16 flex items-center px-6 border-b border-gray-200">
                <span className="font-display text-2xl text-secondary">RM LUXURY</span>
            </div>
