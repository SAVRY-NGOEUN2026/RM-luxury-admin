...
import { DollarSign, ShoppingBag, Shirt, Users, ArrowUpRight, ArrowDownRight, Clock, CheckCircle2 } from 'lucide-react';
...
const data = [
  ...
  { name: 'Wed', revenue: 540 },
  { name: 'Thu', revenue: 790 },
  { name: 'Fri', revenue: 1120 },
  { name: 'Sat', revenue: 1480 },
  { name: 'Sun', revenue: 1260 },
];
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard title="Total Revenue" value="$6,290.00" icon={<DollarSign size={24} />} trend="up" trendValue="14.2" />
                <StatCard title="Total Orders" value="212" icon={<ShoppingBag size={24} />} trend="up" trendValue="9.6" />
                <StatCard title="Total Products" value={String(allProducts.length)} icon={<Shirt size={24} />} trend="up" trendValue="3.1" />
                <StatCard title="Total Customers" value="134" icon={<Users size={24} />} trend="up" trendValue="5.4" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <a href="#/orders" className="text-sm font-medium text-primary hover:text-primary-dark">View All</a>
                    </div>
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="text-sm divide-y divide-gray-50">
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                    <td className="py-4 font-semibold text-gray-900">#RM-1092</td>
                                    <td className="py-4 text-gray-600">Sokha N.</td>
                                    <td className="py-4 font-semibold text-gray-900">$78.00</td>
                                    <td className="py-4">
                                ...
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                    <td className="py-4 font-semibold text-gray-900">#RM-1093</td>
                                    <td className="py-4 text-gray-600">Minea K.</td>
                                    <td className="py-4 font-semibold text-gray-900">$52.00</td>
                                    <td className="py-4">
                                ...
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                    <td className="py-4 font-semibold text-gray-900">#RM-1094</td>
                                    <td className="py-4 text-gray-600">Rath T.</td>
                                    <td className="py-4 font-semibold text-gray-900">$110.50</td>
                                    <td className="py-4">
                            ...
                            <div key={item.id} className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 font-medium">{item.rev} reviews</p>
                                    </div>
                                </div>
