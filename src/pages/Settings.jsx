                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    type="email"
                                    defaultValue="admin@rmluxury.com"
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                                />
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Accepted Payments</label>
                                <div className="flex flex-wrap gap-2 mt-1">
                                    {['VISA', 'ABA', 'KHQR'].map(m => (
                                        <span key={m} className="px-3 py-1.5 bg-secondary text-white rounded-md text-xs font-semibold">{m}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
