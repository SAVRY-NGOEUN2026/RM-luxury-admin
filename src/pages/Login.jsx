...
import { Gem, Lock, User, ArrowRight } from 'lucide-react';
...
const Login = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen bg-[#f7f5f6] flex items-center justify-center p-4">
            <div className="bg-white max-w-md w-full rounded-3xl shadow-xl overflow-hidden">
                <div className="bg-secondary p-8 text-center">
                    ...
                    <h2 className="font-display text-3xl text-white mb-1">RM LUXURY</h2>
                    <p className="text-white/60 text-sm">Admin Panel &mdash; Please sign in to continue.</p>
                </div>
