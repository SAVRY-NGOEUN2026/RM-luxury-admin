...
const dummyMessages = [
    {
        ...
        preview: 'Do you have the Preppy Knit Skirt in size M?',
        fullMessage: 'Hi RM Luxury team,\n\nI love the Preppy Knit and Pleated Skirt but I cannot find a size M on the site. Is it back in stock soon? I would like to order 2 pieces.\n\nThanks,\nSokha',
        time: '10:30 AM',
        date: 'Today',
        unread: true,
    },
    {
        ...
        preview: 'Feedback on the Y2K Ruched Crop set',
        fullMessage: 'Hello!\n\nJust wanted to say the Y2K Ruched Crop and Wide Jeans set is amazing quality for the price. The fit is perfect and shipping to Siem Reap only took 3 days. Will be ordering again!\n\nBest,\nMinea',
        time: 'Yesterday',
        date: 'Jun 29, 2026',
        unread: false,
    },
    {
        ...
        preview: 'Question about the RMLUX40 promo code',
        fullMessage: 'Hi there, does the RMLUX40 code work on the Men Smart Casual collection too, or only Women items? Also do you ship to Battambang?',
        time: 'Jun 27',
        date: 'Jun 27, 2026',
        unread: false,
    },
